...
const EditAssignmentModal: React.FC<EditAssignmentModalProps> = ({ isOpen, onClose, assignment }) => {
  ...
  useEffect(() => {
    if (assignment && isOpen) {
      ...
      const getFacultyId = (faculty: any) => {
      ...
      setFormData({
        ...
        course: getCourseId(assignment.course),
        faculty: getFacultyId(assignment.faculty),
        ...
        extendedDueDate: assignment.extendedDueDate ? 
          assignment.extendedDueDate.split('T')[0] + 'T' + assignment.extendedDueDate.split('T')[1].substring(0, 5) : '',
