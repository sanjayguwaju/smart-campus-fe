    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-2xl shadow-2xl p-0 w-full max-w-md animate-fadeIn">
        <div className="flex flex-col items-center p-6">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-1">Delete Blog Post</h2>
          <p className="text-sm text-gray-500 mb-4">This action cannot be undone.</p>

          <div className="w-full bg-gray-50 rounded-lg border border-gray-200 p-4 mb-6 flex flex-col items-center">
            <span className="text-base font-medium text-gray-800 mb-1">{blogTitle}</span>
            {/* Add more blog details here if needed */}
          </div>

          <p className="text-sm text-gray-600 text-center mb-6">
            Are you sure you want to delete this blog post? This will permanently remove the blog post and all associated data.
          </p>
          ...
          <div className="flex w-full gap-3">
            ...
            >
              {deleteBlog.isPending ? 'Deleting...' : 'Delete Blog Post'}
            </button>
          </div>
        </div>
      </div>
